...
const MENU_ITEMS = [
  { href: '/', text: 'Home' },
  { href: '/projects', text: 'Projects', showOnMobile: true },
...
export default function Header() {
  ...
  return (
    <header className='text-center font-sans font-black uppercase md:px-8 md:pt-8 xl:px-16 xl:pt-16'>
      <div className='bg-background m-auto grid max-w-(--page-max-width) grid-cols-[64px_1fr_1fr] border-b-2 border-black md:grid-cols-5 md:border-2'>
